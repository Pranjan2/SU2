/*!
 * \file CDiscAdjMDODriver.hpp
 * \brief Headers of the main subroutines for driving MDO problems.
 *        The subroutines and functions are in the <i>driver_structure.cpp</i> file.
 * \author P.Ranjan, T. Economon, H. Kline, R. Sanchez
...
/*!
 * \class CDiscAdjMDODriver
 * \brief Class for driving Multi-disciplinary adjoint solvers.
 * \author P. Ranjan
 * \version 7.2.0 "Columbia"
 */

/*---Define class and inherit all public methods from CSinglezoneDriver---*/
class CDiscAdjMDODriver : public CSinglezoneDriver 
{
protected:
...
public:
   ...
   */
    ...
    CDiscAdjMDODriver(char* confFile,unsigned short val_nZone,SU2_Comm MPICommunicator);

    /*!
   * \brief Destructor of the class.
   */
    ~CDiscAdjMDODriver(void) override;
