...
//         //Pn = solver_container[ZONE_0][INST_0][MESH_0][FLOW_SOL]->nodes[nodeVertex[iVertex]]->GetPressure();
...
//           if (geometry_container[ZONE_0][INST_0][MESH_0]->IFNodes->GetColor() == solverProcessIndex) 
//           {
